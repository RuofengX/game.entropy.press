...
class Property(_message.Message):
    __slots__ = ["delta", "destroy", "health", "struct", "shield", "shield_recovery"]
    ...
    def __init__(self, delta: _Optional[_Union[Delta, _Mapping]] = ..., destroy: bool = ..., health: _Optional[float] = ..., struct: _Optional[float] = ..., shield: _Optional[float] = ..., shield_recovery: _Optional[float] = ...) -> None: ...
