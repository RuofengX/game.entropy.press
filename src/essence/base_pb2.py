...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_ENTITY']._serialized_end=152
  _globals['_FIELD']._serialized_start=154
  _globals['_FIELD']._serialized_end=191
